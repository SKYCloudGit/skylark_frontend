...
const HierarchyTitle = () => {
  ...
  const handleAddTitle = async () => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/hierarchy/titles`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  const handleUpdateHierarchy = async () => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/hierarchy/titles/modify/${editingId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  const confirmDelete = async () => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/hierarchy/titles/${selectedTitle.id}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${token}`,
        },
